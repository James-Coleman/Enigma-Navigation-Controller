...
class CodeViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var left = (rotor:["A":"E", "B":"K", "C":"M", "D":"F", "E":"L", "F":"G", "G":"D", "H":"Q", "I":"V", "J":"Z", "K":"N", "L":"T", "M":"O", "N":"W", "O":"Y", "P":"H", "Q":"X", "R":"U", "S":"S", "T":"P", "U":"A", "V":"I", "W":"B", "X":"R", "Y":"C", "Z":"J"], step:"R")
    var centre = (rotor:["A":"A", "B":"J", "C":"D", "D":"K", "E":"S", "F":"I", "G":"R", "H":"U", "I":"X", "J":"B", "K":"L", "L":"H", "M":"W", "N":"T", "O":"M", "P":"C", "Q":"Q", "R":"G", "S":"Z", "T":"N", "U":"P", "V":"Y", "W":"F", "X":"V", "Y":"O", "Z":"E"], step:"F")
    var right = (rotor:["A":"B", "B":"D", "C":"F", "D":"H", "E":"J", "F":"L", "G":"C", "H":"P", "I":"R", "J":"T", "K":"X", "L":"V", "M":"Z", "N":"N", "O":"Y", "P":"E", "Q":"I", "R":"W", "S":"G", "T":"A", "U":"K", "V":"M", "W":"U", "X":"S", "Y":"Q", "Z":"O"], step:"W")
    ...
    // MARK: Default rotor positions.
    
    var rotorWindowLeft = 25
    var rotorWindowCentre = 25
    var rotorWindowRight = 25
    ...
    override func viewDidLoad() {
        ...
        rotorWindows.selectRow(rotorWindowLeft, inComponent: 0, animated: false)
        rotorWindows.selectRow(rotorWindowCentre, inComponent: 1, animated: false)
        rotorWindows.selectRow(rotorWindowRight, inComponent: 2, animated: false)
    ...
    */
    ...
    @IBAction func button(sender: UIButton) {
        ...
        switch coded {
        case "Q": qBulb.textColor = UIColor.yellowColor()
        case "W": wBulb.textColor = UIColor.yellowColor()
        case "E": eBulb.textColor = UIColor.yellowColor()
        case "R": rBulb.textColor = UIColor.yellowColor()
        case "T": tBulb.textColor = UIColor.yellowColor()
        case "Z": zBulb.textColor = UIColor.yellowColor()
        case "U": uBulb.textColor = UIColor.yellowColor()
        case "I": iBulb.textColor = UIColor.yellowColor()
        case "O": oBulb.textColor = UIColor.yellowColor()
            
        case "A": aBulb.textColor = UIColor.yellowColor()
        case "S": sBulb.textColor = UIColor.yellowColor()
        case "D": dBulb.textColor = UIColor.yellowColor()
        case "F": fBulb.textColor = UIColor.yellowColor()
        case "G": gBulb.textColor = UIColor.yellowColor()
        case "H": hBulb.textColor = UIColor.yellowColor()
        case "J": jBulb.textColor = UIColor.yellowColor()
        case "K": kBulb.textColor = UIColor.yellowColor()
            
        case "P": pBulb.textColor = UIColor.yellowColor()
        case "Y": yBulb.textColor = UIColor.yellowColor()
        case "X": xBulb.textColor = UIColor.yellowColor()
        case "C": cBulb.textColor = UIColor.yellowColor()
        case "V": vBulb.textColor = UIColor.yellowColor()
        case "B": bBulb.textColor = UIColor.yellowColor()
        case "N": nBulb.textColor = UIColor.yellowColor()
        case "M": mBulb.textColor = UIColor.yellowColor()
        case "L": lBulb.textColor = UIColor.yellowColor()
        default: break
        }
    }
